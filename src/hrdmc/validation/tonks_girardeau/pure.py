...
from hrdmc.production.pure_walking import compact_dmc_seed_summary
from hrdmc.validation.tonks_girardeau.models import TrappedTGSeedRun
...
def trapped_tg_pure_config(
    *,
    ...
    clean_lags = tuple(sorted({int(lag) for lag in lag_steps}))
