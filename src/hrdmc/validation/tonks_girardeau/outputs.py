...
from hrdmc.plotting.figures.exact_validation_packet import write_exact_validation_packet_plots
...
def anchor_row_from_trapped(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "density_resolution_status": comparison["density_resolution_status"],
        "density_accounting_status": comparison["density_accounting_status"],
        ...
        "mixed_r2_relative_error_diagnostic": comparison["mixed_r2_relative_error_diagnostic"],
        "mixed_rms_relative_error_diagnostic": comparison["mixed_rms_relative_error_diagnostic"],
        "mixed_density_relative_l2_diagnostic": comparison["mixed_density_relative_l2_diagnostic"],
...
def write_exact_validation_manifest(
    ...
    write_run_manifest(
        output_dir,
        run_name="dmc_exact_validation_packet",
        config=dmc_run_config(
            run_kind="dmc_exact_validation_packet",
