...
from hrdmc.artifacts.progress import QueuedProgress
...
from hrdmc.validation.tonks_girardeau.comparison import (
    density_profile_payload,
    trapped_tg_exact_comparison,
)
from hrdmc.validation.tonks_girardeau.models import (
    TrappedTGAnchor,
    TrappedTGSeedRun,
)
from hrdmc.validation.tonks_girardeau.pure import (
    pure_config_payload,
...
def run_trapped_tg_anchor(
    ...
    *,
    ...
    return {
        ...
        "anchor_type": "trapped_tg_local_dmc_plus_transported_fw",
        "exact_solution": {
