...
from hrdmc.sampling.dmc.population import finite_mean, safe_fraction
...
class DMCTransportEvent:
    ...
    convention: _DMCTransportConvention = _DMCTransportConvention()
