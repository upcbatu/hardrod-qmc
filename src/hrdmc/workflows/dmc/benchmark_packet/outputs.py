...
def write_benchmark_packet_table(output_dir: Path, payload: dict[str, Any]) -> Path:
    ...
    row = {
        ...
        "rms_mc_statistical_stderr": estimates["rms"].get("mc_statistical_stderr", ""),
        "rms_fw_lag_systematic_upper_bound": estimates["rms"].get(
            "fw_lag_systematic_upper_bound",
            "",
        ),
        "rms_fw_lag_systematic_relative_upper_bound": estimates["rms"].get(
            "fw_lag_systematic_relative_upper_bound",
            "",
        ),
        "rms_fw_lag_relative_equivalence_margin": estimates["rms"].get(
            "fw_lag_relative_equivalence_margin",
            "",
        ),
        ...
        "fw_density_relative_l2_vs_lda": estimates["density"].get(
            "fw_relative_l2_vs_lda",
            "",
        ),
        "fw_density_relative_l2_vs_mixed": estimates["density"].get(
            "fw_relative_l2_vs_mixed",
            "",
        ),
        "density_fw_lag_systematic_relative_l2_upper_bound": estimates["density"].get(
            "fw_lag_systematic_relative_l2_upper_bound",
            "",
        ),
        "density_fw_lag_relative_l2_equivalence_margin": estimates["density"].get(
        ...
        "r2_plateau_method": aggregate_r2.get("method", ""),
        "r2_rms_relative_equivalence_margin": aggregate_r2.get(
            "rms_relative_equivalence_margin",
            "",
        ),
        "r2_simultaneous_rms_relative_upper_bound": aggregate_r2.get(
            "simultaneous_rms_relative_upper_bound",
            "",
        ),
        "r2_equivalence_pass": aggregate_r2.get("equivalence_pass", ""),
...
def write_benchmark_packet_fw_plateau_table(output_dir: Path, payload: dict[str, Any]) -> Path:
    fields = [
        ...
        "rms_relative_equivalence_margin",
        "simultaneous_rms_relative_upper_bound",
        "observed_max_rms_pairwise_relative_difference",
        "equivalence_pass",
        "window_lags",
...
def write_benchmark_packet_density_fw_table(output_dir: Path, payload: dict[str, Any]) -> Path:
    fields = [
        ...
        "fw_density_relative_l2_vs_lda",
        "fw_density_relative_l2_vs_mixed",
        "slope_sigma_ratio",
        "window_sigma_ratio",
        "slope_delta",
        "slope_threshold",
        ...
        "observed_max_density_relative_l2",
        "window_lags",
        "selected_window_lags",
        "excluded_unsupported_lags",
        "aggregate_genealogy_status",
...
def _aggregate_density_row(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        **_plateau_diagnostic_row(diagnostics),
        ...
        "density_relative_l2_equivalence_margin": diagnostics.get(
            "density_relative_l2_equivalence_margin",
            "",
        ),
        "simultaneous_density_relative_l2_upper_bound": diagnostics.get(
            "simultaneous_density_relative_l2_upper_bound",
            "",
        ),
        "observed_max_density_relative_l2": diagnostics.get(
            "observed_max_density_relative_l2",
            "",
        ),
        "lag_max_block_count": "",
...
def _plateau_diagnostic_row(diagnostics: dict[str, Any]) -> dict[str, Any]:
    return {
        ...
        "plateau_method": diagnostics.get("method", ""),
        "equivalence_confidence_level": diagnostics.get("confidence_level", ""),
        "rms_relative_equivalence_margin": diagnostics.get(
            "rms_relative_equivalence_margin",
            "",
        ),
        ...
        "observed_max_rms_pairwise_relative_difference": diagnostics.get(
            "observed_max_rms_pairwise_relative_difference",
            "",
        ),
        "equivalence_pass": diagnostics.get("equivalence_pass", ""),
