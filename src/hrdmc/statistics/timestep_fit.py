...
class LargestTimeStepStability:
    ...
    def to_dict(self) -> dict[str, float | str | bool | None]:
        return asdict(self)
@dataclass(frozen=True)
class _LeadingModelSensitivity:
...
class TimeStepExtrapolation:
    ...
    leading_model_sensitivity: _LeadingModelSensitivity
...
def analyze_time_step_extrapolation(
    ...
    *,
    ...
    if linear_fit.goodness_of_fit_status == "fit_inadequate":
        ...
        quadratic_fit.goodness_of_fit_status == "fit_inadequate"
        or sensitivity.classification == "model_sensitive"
        or any(
...
def _leading_model_sensitivity(
    ...
    *,
    ...
    return _LeadingModelSensitivity(
