...
class _PairwiseEquivalenceBound:
    first_index: int
    second_index: int
...
class SimultaneousPairwiseEquivalenceResult:
    ...
    pairwise_bounds: tuple[_PairwiseEquivalenceBound, ...]
...
@dataclass(frozen=True)
class _PairwiseNormEquivalenceBound:
    first_index: int
    second_index: int
...
class SimultaneousPairwiseNormEquivalenceResult:
    ...
    simultaneous_upper_bound: float
    pairwise_bounds: tuple[_PairwiseNormEquivalenceBound, ...]
    def to_dict(self) -> dict[str, object]:
        return {
            "equivalent": self.equivalent,
            "replicate_count": self.replicate_count,
...
def simultaneous_pairwise_equivalence(
    ...
    *,
    ...
    bounds: list[_PairwiseEquivalenceBound] = []
...
def simultaneous_pairwise_norm_equivalence(
    ...
    *,
    ...
    bounds: list[_PairwiseNormEquivalenceBound] = []
    for first_index, second_index in pairs:
        differences = values[:, first_index, :] - values[:, second_index, :]
