...
from hrdmc.statistics.timeseries import CHAIN_ACCEPTED, CHAIN_SPREAD_WARNING
...
def energy_validation_status(stationarity: dict[str, Any]) -> str:
    """Classify the energy-validity state of one stationarity payload."""
    ...
    if energy_stationarity not in {CHAIN_ACCEPTED, CHAIN_SPREAD_WARNING}:
